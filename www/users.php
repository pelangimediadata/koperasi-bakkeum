...
<div class="app-container">
    ...
    <main class="main-content">
			...
			<div style="background: #203a43; padding: 25px; border-radius: 12px; color: #ffffff; margin-bottom: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <h1 style="font-size: 22px; font-weight: bold; margin-bottom: 6px; letter-spacing: 0.5px;">ADMIN AREA</h1>
                <p style="font-size: 14px; color: #cbd5e1; margin-bottom: 15px;">Pengaturan Pengguna & Akses Sistem - Koperasi Bakkeum</p>
