...
<head>
    ...
    <style>
        * {
        ...
        .btn-warning { background-color: #ed6c02; color: white; padding: 6px 10px; font-size: 12px; }
        .btn-danger { background-color: #d32f2f; color: white; padding: 6px 10px; font-size: 12px; }
        ...
        table { width: 100%; border-collapse: collapse; margin-top: 10px; text-align: left; font-size: 14px; white-space: nowrap; }
