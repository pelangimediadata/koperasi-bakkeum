...
if ($is_admin && isset($_GET['db_action'])) {
    ...
    if ($action === 'restore' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_FILES['backup_file']) && $_FILES['backup_file']['error'] === UPLOAD_ERR_OK) {
            ...
            $message = "Pilih file backup database yang valid!";
            $message_type = "danger";
        }
    }
        ...
        <div class="content">
            ...
            <?php if ($is_admin) { ?>
                <div class="admin-db-menu">
					...
					<button class="btn-db btn-backup"  onclick="location.href='backup_db.php'" class="btn btn-primary">💾 Backup Database</button>
...
<div id="restoreModal" class="modal">
    <div class="modal-content">
        ...
        <form action="dashboard.php?db_action=restore" method="POST" enctype="multipart/form-data">
            <p style="font-size: 13px; color: #666;">Pilih file cadangan database (format <strong>.sql</strong>):</p>
            <input type="file" name="backup_file" accept=".sql" required style="margin-bottom: 15px; width: 100%;">
